...
func TestRun_FromScratchPrunesRegisteredGitWorktrees(t *testing.T) {
	...
	runGit(t, repoRoot, "config", "user.email", "harnest@example.test")
	runGit(t, repoRoot, "config", "user.name", "harnest test")
...
func TestRun_FromScratchCleanupUsesOldRunConfigSnapshotRepoRoot(t *testing.T) {
	...
	runGit(t, oldRepoRoot, "config", "user.email", "harnest@example.test")
	runGit(t, oldRepoRoot, "config", "user.name", "harnest test")
