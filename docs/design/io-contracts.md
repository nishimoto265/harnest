...
- 実行直前にも current policy snapshot を `.auto-improve/lessons/` と `.auto-improve/checklist.md` として worktree に overlay する。pass2 では experiment lesson も同じ overlay に追加する
